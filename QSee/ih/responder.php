...
$log_hospital = $_SESSION['hospital'];
...
if (isset($_POST['submit_pass'])) {
  ...
  $msg=mysqli_query($con,"UPDATE sub_admin SET password = '".$password_hash."' WHERE id = '".$_SESSION['id']."' ");
    if($msg)
      {
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="font-family: arial;">
          <ul class="nav navbar-nav">
            <li class="active" ><a href="#" onclick="window.location.reload(true);" style="color: #000000; border-top-left-radius: 10px; border-top-right-radius: 10px;"><?php echo $log_username;?><span class="sr-only">(current)</span></a></li>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Acccount Details</h4>
              </div>
                      ...
                      <div class="modal-header">
                        ...
                        <div class="modal-body">
                          <div class="table-responsive container">
                            ...
                            <br>
                            <div class="row" style="border-radius: 7px; margin-bottom: 0.5em;">
                              
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style=" color: #ffffff; margin-bottom: 0.1em;">
                                  <a href="update.php?id=<?php echo $row['id'];?>&respondent=<?php echo $row['respondent'];?>">
                                    <input id="submit_button" type="submit" onclick="return confirm('Proceed to respond?')" value="Click to Respond" class=" btn btn-info my-4 btn-block " style="float: right; border-radius: 20px;" >
                                  </a>
                              </div>
                             </div>
